...
<html>
  ...
  <script type="text/javascript">
		...
		function doApprove(id,name){
			document.forms[0].action = "${basePath}approveborrow.user?book_id="+id+"&book_name="+name;
			document.forms[0].submit();
		}
		function doExpressBook(id){
			document.forms[0].action = "${basePath}expressbook.user?book_id="+id+"&book_name="+name;
			document.forms[0].submit();
		}
		function doSearch(){
			var search = document.getElementById("bookname").value;
			document.forms[0].action = "${basePath}borrow.user?search="+search;
			document.forms[0].submit();
		}
  </script>
    <base href="<%=basePath%>">
  ...
  <body>
  <h3><a href="${basePath }home.user" >返回首页</a></h3>
  <form name="form1" action="" method="post" enctype="multipart/form-data">
        ...
        <table width="100%" border="0">
                   <tr class="t_tit">
                       ...
                       <td width="140" align="center">书籍名称</td>
                   ...
                   <c:forEach items="${requestScope.pageBean.pageData }" var="book">
                       <tr bgcolor="f8f8f8">
                           ...
                           <td align="center">
                               <a href="javascript:doApprove(${book.bookId },'${book.bookName }')">申请借书</a>
                               <a href="javascript:doExpressBook(${book.bookId },'${book.bookName }')">快递借书</a>
                           </td>
                       </tr>
                   </c:forEach>
               </table>
         ...
         <script type="text/javascript">
         	function doPageGO(pageNo){
         		document.forms[0].action="${basePath}borrow.user?currentPage="+pageNo;
         		document.forms[0].submit();
         	}
         </script>
  </body>
